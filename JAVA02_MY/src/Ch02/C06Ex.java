...
class Profile{
	...
	//3)"홍길동,대구,프로그래머,컴퓨터공학"을 받아 , 를 기준으로 잘라서 각 멤버에 저장 -> split 사용? 
	...
	//기능
	//1) 멤버변수를 은닉화 하고 getter and setter 를 만들어줍니다(모든 필드 -> private 처리)
	...
	boolean isEquals(String str) {
		...
		//아니면 false 를 리턴
		String params [] = str.split(","); // 0번 인덱스, 1번 인덱스, 2번 인덱스, 3번 인덱스
		if(
