...
//Event 처리를 위해 implements ActionListener 추가
class GUI extends JFrame implements ActionListener{
	
	// component들은 멤버로 등록해야 이벤트 처리 가능
	JButton btn1;
	JButton btn2;
	JButton btn3;
	JButton btn4;
	...
	GUI(String title){
		...
		// event 처리를 위해 class GUI에서 버튼들을 멤버 변수로 등록 
		// JButton 지워주고
