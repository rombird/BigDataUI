...
//		
//		System.out.printf("입력된 두 수의 합은 %d, 차는 %d, 곱은 %d 입니다.", first+second, first-second, first*second);
//	
//		sc.close();
...
//		int a=10;int b=20;
//		System.out.println((a>=b)&&(a>5)); // false -> 왼쪽 조건이 거짓이면 오른쪽 X 
//		System.out.println((a!=b)&&(b>15)); // true -> 왼쪽 조건이 참이면 오른쪽으로 
//				
//		System.out.println((a>=b)||(a>5)); // true -> 왼쪽 조건이 참이면 오른쪽 보지 X(효율성을 위해서 -> 둘 중 하나만 참이라도 참이기 때문에)
...
//		System.out.println(play);
		...
		c = --a + b++; // c = 9 + 10 = 19 -> b = 11
		d = a-- + ++b; // d = 9 + 12 = 21 -> a = 8 
		System.out.printf("a=%d , b=%d , c=%d, d=%d", a, b, c, d); // 8, 12, 19, 21
